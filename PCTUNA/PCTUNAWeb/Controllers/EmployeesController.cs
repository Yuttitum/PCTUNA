...
namespace PCTUNAWeb.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,No,FirstName,LastName,PositionID")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,No,FirstName,LastName,PositionID")] Employee employee)
        {
            if (ModelState.IsValid)
            {
